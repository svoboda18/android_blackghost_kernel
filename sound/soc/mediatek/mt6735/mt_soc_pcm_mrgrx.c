...
static int mtk_afe_mrgrx_probe(struct snd_soc_component *component);
...
static struct snd_soc_component_driver mtk_mrgrx_soc_platform = {
	.ops        = &mtk_mrgrx_ops,
