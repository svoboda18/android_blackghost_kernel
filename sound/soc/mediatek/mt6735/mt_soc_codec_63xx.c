...
static void mt6331_codec_init_reg(struct snd_soc_component *codec)
{
	pr_debug("%s\n", __func__);
...
static int mt6331_codec_probe(struct snd_soc_component *codec)
{
	...
	/* add codec controls */
	snd_soc_add_component_controls(codec, mt6331_snd_controls, ARRAY_SIZE(mt6331_snd_controls));
	snd_soc_add_component_controls(codec, mt6331_UL_Codec_controls,
				   ARRAY_SIZE(mt6331_UL_Codec_controls));
	snd_soc_add_component_controls(codec, mt6331_Voice_Switch, ARRAY_SIZE(mt6331_Voice_Switch));
	snd_soc_add_component_controls(codec, mt6331_pmic_Test_controls,
				   ARRAY_SIZE(mt6331_pmic_Test_controls));

#ifdef CONFIG_MTK_SPEAKER
	snd_soc_add_component_controls(codec, mt6331_snd_Speaker_controls,
...
static void mt6331_codec_remove(struct snd_soc_component *codec)
{
	pr_debug("%s()\n", __func__);
	return;
}

static unsigned int mt6331_read(struct snd_soc_component *component, unsigned int reg)
{
...
static int mt6331_write(struct snd_soc_component *component, unsigned int reg, unsigned int value)
{
