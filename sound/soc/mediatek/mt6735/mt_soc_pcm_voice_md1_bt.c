...
static int mtk_voice_bt_platform_probe(struct snd_soc_component *component);
...
static struct snd_soc_component_driver mtk_soc_voice_bt_platform = {
...
static int mtk_voice_bt_probe(struct platform_device *pdev)
{
	...
	return snd_soc_register_component(&pdev->dev,
					 &mtk_soc_voice_bt_platform, NULL, 0);
}
