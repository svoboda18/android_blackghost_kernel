...
static int mtk_afe_fm_i2s_probe(struct snd_soc_component *component);
...
static struct snd_soc_component_driver mtk_fm_i2s_soc_platform = {
	.ops = &mtk_fm_i2s_ops,
...
static int mtk_fm_i2s_probe(struct platform_device *pdev)
{
	...
	return snd_soc_register_component(&pdev->dev,
					  &mtk_fm_i2s_soc_platform, NULL, 0);
}
