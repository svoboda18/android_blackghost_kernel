...
static const char *speaker_PGA_function[] = { "MUTE", "0Db", "4Db", "5Db", "6Db",
...
"32000", "44100", "48000"}; */
static const char *DAC_DL_PGA_Headset_GAIN[] = { "9Db", "7Db", "5Db", "3Db",
"1Db", "-1Db", "-3Db", "-5Db" };

static const char *DAC_DL_PGA_Handset_GAIN[] = { "-21Db", "-19Db", "-17Db", "-15Db",
"-13Db", "-11Db", "-9Db", "-7Db", "-5Db", "-3Db", "-1Db", "1Db", "3Db", "5Db", "7Db", "9Db"
};

/* Lineout use */
static const char *DAC_DL_PGA_Speaker_GAIN[] = { "8Db", "7Db", "6Db", "5Db", "4Db",
...
static const char *Pmic_LPBK_function[] = { "Off", "LPBK3" };
...
static void mt6350_codec_init_reg(struct snd_soc_component *codec)
{
	pr_warn("%s\n", __func__);
#if 0	/* todo */
...
static int mt6350_codec_probe(struct snd_soc_component *codec)
{
	...
	/* add codec controls */
	snd_soc_add_component_controls(codec, mt6350_snd_controls,
				       ARRAY_SIZE(mt6350_snd_controls));
	snd_soc_add_component_controls(codec, mt6350_UL_Codec_controls,
				       ARRAY_SIZE(mt6350_UL_Codec_controls));
	snd_soc_add_component_controls(codec, mt6350_Voice_Switch,
				       ARRAY_SIZE(mt6350_Voice_Switch));
	snd_soc_add_component_controls(codec, mt6350_pmic_Test_controls,
				       ARRAY_SIZE(mt6350_pmic_Test_controls));

#ifdef CONFIG_MTK_SPEAKER
	snd_soc_add_component_controls(codec, mt6350_snd_Speaker_controls,
	...
	mCodec_data = kzalloc(sizeof(struct mt6350_Codec_Data_Priv),
			      GFP_KERNEL);
	if (!mCodec_data) {
		/*pr_warn("Failed to allocate private data\n");*/
		return -ENOMEM;
	}
	snd_soc_component_set_drvdata(codec, mCodec_data);
...
static unsigned int mt6350_read(struct snd_soc_component *component,
				unsigned int reg)
{
...
static int mt6350_write(struct snd_soc_component *component,
