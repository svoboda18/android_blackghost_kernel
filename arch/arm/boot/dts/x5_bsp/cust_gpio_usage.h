...
#define GPIO_GPS_LNA_PIN         (GPIO3 | 0x80000000)
...
#define GPIO_CAMERA_FLASH_MODE_PIN         (GPIO7 | 0x80000000)
#define GPIO_CAMERA_FLASH_MODE_PIN_M_GPIO  GPIO_MODE_00
#define GPIO_CAMERA_FLASH_MODE_PIN_M_MDEINT  GPIO_MODE_05
