...
#endif 
/*----------------------------------------------------------------------------*/
static DRIVER_ATTR(enable,          0644,  mir3da_enable_show,             mir3da_enable_store);
static DRIVER_ATTR(axis_data,       0644,  mir3da_axis_data_show,          NULL);
static DRIVER_ATTR(reg_data,        0644,  mir3da_reg_data_show,           mir3da_reg_data_store);
static DRIVER_ATTR(log_level,       0644,  mir3da_log_level_show,          mir3da_log_level_store);
static DRIVER_ATTR(primary_offset,  0644,  mir3da_primary_offset_show,     NULL);
static DRIVER_ATTR(vendor,          0644,  mir3da_vendor_show,             NULL);
static DRIVER_ATTR(version,         0644,  mir3da_version_show,            NULL); 
#if MIR3DA_OFFSET_TEMP_SOLUTION
static DRIVER_ATTR(calibrate_miraGSensor,       0644,  mir3da_calibrate_show,          mir3da_calibrate_store);
#endif
#if FILTER_AVERAGE_ENHANCE
static DRIVER_ATTR(average_enhance, 0644,  mir3da_average_enhance_show,    mir3da_average_enhance_store);
#endif 
/*----------------------------------------------------------------------------*/
