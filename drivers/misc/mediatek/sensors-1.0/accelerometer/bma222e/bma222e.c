...
static ssize_t orientation_show(struct device_driver *ddri, char *pbBuf)
{
	ssize_t _tLength = 0;
	struct bma222_i2c_data *obj = obj_i2c_data;
...
static ssize_t orientation_store(struct device_driver *ddri, const char *pbBuf, size_t tCount)
{
	int _nDirection = 0;
