...
#define EMI_REG_BASE            0xF0205000	/*mt6580 is in TOPCKGEN_BASE */
...
#define EMI_REG_BASE            0x10205000	/*mt6580 is in TOPCKGEN_BASE */
#endif


/*APMIXED  //use for special source clock remove in mt6580 */
