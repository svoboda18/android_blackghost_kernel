...
#define LOG_INF(format, args...)    printk(PFX "[%s] " format, __FUNCTION__, ##args) //xlog_printk(ANDROID_LOG_INFO   , PFX, "[%s] " format, __FUNCTION__, ##args)
...
static imgsensor_info_struct imgsensor_info = { 
    ...
    .checksum_value = 0x9440717e,        //checksum value for Camera Auto Test
...
UINT32 SP2508_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
