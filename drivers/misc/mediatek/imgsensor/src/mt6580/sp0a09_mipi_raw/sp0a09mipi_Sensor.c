...
static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = SP0A09_MIPI_SENSOR_ID,
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    switch (image_mirror) {
        case IMAGE_NORMAL:
            write_cmos_sensor0(0x31,0x00);
            break;
        case IMAGE_H_MIRROR:
            write_cmos_sensor0(0x31,0x01);
            break;
        case IMAGE_V_MIRROR:
            write_cmos_sensor0(0x31,0x02);
            break;
        case IMAGE_HV_MIRROR:
            write_cmos_sensor0(0x31,0x03);
            break;
        default:
...
UINT32 SP0A09MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
