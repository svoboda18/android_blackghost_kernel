...
#define AF_ROM_START        0x35
#define AF_WIDTH            0x07
...
//ITD:modify XLWLHBLEJ-299 by quan.chang 190712 end
extern int iWriteReg(u16 a_u2Addr, u32 a_u4Data, u32 a_u4Bytes, u16 i2cId);
otp_af_struct otp_af;
