...
void GC0310_MIPI_get_AEAWB_lock(MUINT32 * pAElockRet32, MUINT32 * pAWBlockRet32)
{
    *pAElockRet32 = 1;
    *pAWBlockRet32 = 1;
    LOG_INF("[GC0310]GetAEAWBLock,AE=%d ,AWB=%d\n,",(MUINT32)*pAElockRet32, (MUINT32)*pAWBlockRet32);
}
...
//		break;
	...
	case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
		...
		GC0310_MIPI_get_AEAWB_lock((MUINT32 *)(uintptr_t)(*feature_data), (MUINT32 *)(uintptr_t)*(feature_data+1));
	break;
