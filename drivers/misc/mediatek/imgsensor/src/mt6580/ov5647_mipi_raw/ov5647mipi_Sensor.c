...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0x9a14e9b7,        //checksum value for Camera Auto Test
    ...
    .i2c_addr_table = {0x6c,0x6d,0x21,0x20, 0xff},//0x6c 0x6d & 0x21 0x20
    .i2c_speed = 150,
};
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
			printk("wangguiwu ov5647 #### sensor_id=%d \r\n",*sensor_id);
