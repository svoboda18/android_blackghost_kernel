...
static struct imgsensor_struct imgsensor = {
	.mirror = IMAGE_H_MIRROR,//IMAGE_NORMAL,//IMAGE_HV_MIRROR,		IMAGE_H_MIRROR	IMAGE_V_MIRROR	//mirrorflip information //zhaozhensen@wind-mobi.com 20161017
...
{
    return (((read_cmos_sensor(0x0F17) << 8) | read_cmos_sensor(0x0F16)) + 0x7BC3); //wangzhongping changed from hi846 -> sp8409, (0x0846 + 0x7BC3 = 0x8409)
}
