...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = BF2253LMIPI_SENSOR_ID,	//0x2253	//record sensor id defined in Kd_imgsensor.h
	...
	.i2c_addr_table				= {0xda,0xdc,0xff},			//record sensor support all write id addr, only supprt 4, must end with 0xff
};
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xe2, 0x0e);//06
	write_cmos_sensor(0xe3, 0x0e);
	write_cmos_sensor(0xe4, 0x40);
	write_cmos_sensor(0xe5, 0x33);//67
	write_cmos_sensor(0xe6, 0x00);//02
...
UINT32 BF2253LMIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
