...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.checksum_value = 0xc3dd012b, //0x752cfcc1,//0xc3dd012b,
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb,	//Gr,Gb
...
static struct imgsensor_struct imgsensor = {
    .mirror = IMAGE_NORMAL,//IMAGE_NORMAL, IMAGE_HV_MIRROR               //mirrorflip information
...
//    unsigned long long *feature_return_para=(unsigned long long *) feature_para;
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_IHDR_SHUTTER_GAIN:
            //LOG_INF("SENSOR_SET_SENSOR_IHDR LE=%d, SE=%d, Gain=%d, %d,%d \n",(UINT16)*feature_data,(UINT16)*(feature_data+1),(UINT16)*(feature_data+2));
