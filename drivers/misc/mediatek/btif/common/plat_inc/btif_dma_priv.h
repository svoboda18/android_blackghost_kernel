...
#if defined(CONFIG_ARCH_MT6580) || defined(CONFIG_MACH_MT6580)
#define MTK_BTIF_APDMA_CLK_CG MT_CG_APDMA_SW_CG
#elif defined(CONFIG_ARCH_MT6735) || defined(CONFIG_MACH_MT6735)
...
#define TX_DMA_VFF_ADDR_H(base)     (unsigned long)(base + 0x54)
...
#define RX_DMA_VFF_ADDR_H(base)     (unsigned long)(base + 0x54)
...
struct _MTK_BTIF_DMA_VFIFO_ {
	...
	unsigned int wpt;	/*DMA's write pointer, */
		/* which is maintained by SW for Tx DMA and HW for Rx DMA */
	unsigned int last_wpt_wrap;	/*last wrap bit for wpt */
	unsigned int rpt;	/*DMA's read pointer, */
		/* which is maintained by HW for Tx DMA and SW for Rx DMA */
