...
#define WRAP_RD32(addr) \
    tkcore_pmic_sec_read((void *)addr)

#define WRAP_WR32(addr, val) \
   tkcore_pmic_sec_write((void *) ((addr) - (u32) PMIC_WRAP_BASE), val)

#define WRAP_SET_BIT(BS, REG) \
   tkcore_pmic_sec_write((void *) ((REG) - (u32) PMIC_WRAP_BASE), (__raw_readl((void *)REG) | (U32)(BS)))
