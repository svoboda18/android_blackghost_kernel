...
#define LOG_CONSTRAINT_ADJ      (0) /* TBD */
...
signed int ISP_DumpReg(void)
{
	...
	/* debug port */
	ISP_WR32((ISP_ADDR + 0x160), 0x6000);
	LOG_INF("set 4160=0x6000: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x7000);
	LOG_INF("set 4160=0x7000: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x9000);
	LOG_INF("set 4160=0x9000: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x9001);
	LOG_INF("set 4160=0x9001: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x9002);
	LOG_INF("set 4160=0x9002: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x9003);
	LOG_INF("set 4160=0x9003: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x9004);
	LOG_INF("set 4160=0x9004: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x9005);
	LOG_INF("set 4160=0x9005: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x9006);
	LOG_INF("set 4160=0x9006: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x9007);
	LOG_INF("set 4160=0x9007: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x9008);
	LOG_INF("set 4160=0x9008: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x9009);
	LOG_INF("set 4160=0x9009: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x900a);
	LOG_INF("set 4160=0x900a: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x900b);
	LOG_INF("set 4160=0x900b: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x900c);
	LOG_INF("set 4160=0x900c: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x900d);
	LOG_INF("set 4160=0x900d: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x900e);
	LOG_INF("set 4160=0x900e: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x900f);
	LOG_INF("set 4160=0x900f: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0xa000);
	LOG_INF("set 4160=0xa000: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));

	ISP_WR32((ISP_ADDR + 0x160), 0x4000);
	LOG_INF("set 4160=0x4000: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x4005);
	LOG_INF("set 4160=0x4005: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x400d);
	LOG_INF("set 4160=0x400d: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x400e);
	LOG_INF("set 4160=0x400e: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x400f);
	LOG_INF("set 4160=0x400f: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));

	ISP_WR32((ISP_ADDR + 0x160), 0x3001);
	LOG_INF("set 4160=0x3001: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x3002);
	LOG_INF("set 4160=0x3002: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x3004);
	LOG_INF("set 4160=0x3004: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x3005);
	LOG_INF("set 4160=0x3005: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x3006);
	LOG_INF("set 4160=0x3006: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));

	ISP_WR32((ISP_ADDR + 0x160), 0x2000);
	LOG_INF("set 4160=0x2000: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x2001);
	LOG_INF("set 4160=0x2001: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x2002);
	LOG_INF("set 4160=0x2002: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x2003);
	LOG_INF("set 4160=0x2003: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x2006);
	LOG_INF("set 4160=0x2006: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	ISP_WR32((ISP_ADDR + 0x160), 0x2009);
	LOG_INF("set 4160=0x2009: 0x%08X %08X",
	ISP_TPIPE_ADDR + 0x164,
	ISP_RD32((void *)(ISP_ADDR + 0x164)));
	/* DCM */
	LOG_INF("0x%08X %08X", ISP_TPIPE_ADDR + 0x194,
	ISP_RD32((void *)(ISP_ADDR + 0x194)));
	LOG_INF("0x%08X %08X", ISP_TPIPE_ADDR + 0x198,
	ISP_RD32((void *)(ISP_ADDR + 0x198)));
	LOG_INF("0x%08X %08X", ISP_TPIPE_ADDR + 0x19c,
	ISP_RD32((void *)(ISP_ADDR + 0x19c)));
	/* unp offset */
...
static signed int ISP_probe(struct platform_device *pDev)
{
	...
	isp_wake_lock = wakeup_source_register(NULL, "isp_lock_wakelock");
#else
...
enum m4u_callback_ret ISP_M4U_TranslationFault_callback(
int port, unsigned int mva, void *data)
{
