...
static int cdfinger_probe(struct spi_device *spi)
{
	...
	printk("chenls cdfinger cdfinger_probe enter new 20220107\n");
	...
	cdfinger->cdfinger_lock = wakeup_source_register(NULL, "cdfinger_process_wakelock");
#else
...
free_wakelock:
	...
	wakeup_source_unregister(cdfinger->cdfinger_lock);
#else
