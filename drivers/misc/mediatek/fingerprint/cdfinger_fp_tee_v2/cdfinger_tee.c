...
static void cdf_enable_clk(struct cdfinger_data *cdfinger)
{
...
static void cdf_disable_clk(struct cdfinger_data *cdfinger)
{
...
static void cdfinger_reset(int count)
{
	...
	CDFINGER_FUNCTION("enter count:%d\n",count);
...
#endif
{
	...
	CDFINGER_ERR("%s: test 001!\n", __func__);
	//mt_spi_enable_master_clk(cdfinger->spi);
	CDFINGER_ERR("%s: test 002!\n", __func__);
