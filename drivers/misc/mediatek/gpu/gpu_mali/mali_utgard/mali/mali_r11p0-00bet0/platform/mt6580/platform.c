...
// this define should be include  arch/arm/mach-mediatek/include/mach/memory.h
// it can`t be include now. I have to define IO_VIRT_TO_PHYS in platform.c.
// it should be fixed by other RD.
