/*
 * Copyright (C) 2010-2015, 2017-2018, 2020 ARM Limited. All rights reserved.
 * 
...
int mem_dump_mmu_page_table_wrapper(struct mali_session_data *session_data, _mali_uk_dump_mmu_page_table_s __user *uargs)
{
	...
	if (0 != copy_to_user(user_buffer, buffer, kargs.register_writes_size + kargs.page_table_dump_size))
		goto err_exit;
