...
int m4u_manual_insert_entry(int m4u_id, unsigned int EntryMVA, int layer,
	int pt_type, int secure, int Lock, unsigned int pa);
int m4u_dump_valid_main_tlb(int m4u_id, int m4u_slave_id);
int m4u_get_pt_type(struct m4u_domain *domain, unsigned int mva);
...
void m4u_get_pgd(struct m4u_client *client, int port,
	void **pgd_va, void **pgd_pa, unsigned int *size);
unsigned long m4u_mva_to_pa(struct m4u_client *client,
