...
#ifdef CONFIG_TRUSTKERNEL_TEE_SECURE_TIMER
...
int tee_read_secure_rtc_time(uint64_t *timestamp)
{
    unsigned long time, flags;
...
#ifdef CONFIG_TRUSTKERNEL_TEE_SECURE_TIMER
    tkcore_register_read_rtc_function(tee_read_secure_rtc_time);
#endif
