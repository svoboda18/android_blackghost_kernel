...
#define __ENV_H__
	...
	defined(CONFIG_MTK_UFS_SUPPORT) || defined(CONFIG_MMC_MTK)
...
#define CFG_ENV_DATA_SIZE (CFG_ENV_SIZE- \
	sizeof(g_env.checksum)-sizeof(g_env.sig)-sizeof(g_env.sig_1))
#define CFG_ENV_DATA_OFFSET (sizeof(g_env.sig))
#define CFG_ENV_SIG_1_OFFSET \
	(CFG_ENV_SIZE - sizeof(g_env.checksum)-sizeof(g_env.sig_1))
