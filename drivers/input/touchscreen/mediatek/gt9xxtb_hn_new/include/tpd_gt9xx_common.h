...
#define GTP_I2C_MASTER_CLOCK          300
#define TPD_MAX_RESET_COUNT           3

#ifdef CONFIG_MTK_I2C_EXTENSION
/*for ARCH_MT6735,ARCH_MT6735M, ARCH_MT6753,ARCH_MT6580,ARCH_MT6755*/
#ifdef CONFIG_GTP_SUPPORT_I2C_DMA
/*#define GTP_ENABLE_WRRD_MODE */
#define GTP_DMA_MAX_WR_SIZE	(GTP_DMA_MAX_TRANSACTION_LENGTH - GTP_ADDR_LENGTH)
#ifdef GTP_ENABLE_WRRD_MODE /*for WRRD(write and read) mode */
#define GTP_DMA_MAX_RD_SIZE	31
#else
#define GTP_DMA_MAX_RD_SIZE	GTP_DMA_MAX_I2C_TRANSFER_SIZE
#endif
#else /*CONFIG_GTP_SUPPORT_I2C_DMA*/ /*FIFO mode*/
#define GTP_FIFO_MAX_RD_SIZE MAX_TRANSACTION_LENGTH
#define GTP_FIFO_MAX_WR_SIZE (MAX_TRANSACTION_LENGTH - GTP_ADDR_LENGTH)
#endif
#else /*DMA mode*/
/*refer to mtxx_i2c_quirks in i2c-mt65xx.c and mtxxx.dtsi*/
#define GTP_DMA_MAX_RD_SIZE	31
#define GTP_DMA_MAX_WR_SIZE	(GTP_DMA_MAX_TRANSACTION_LENGTH - GTP_ADDR_LENGTH)
#endif
...
extern struct mutex gtp_suspend;
...
extern s32 gtp_tool_i2c_read(struct i2c_client *client, u8 *buf, s32 len);
extern s32 gtp_tool_i2c_write(struct i2c_client *client, u8 *buf, s32 len);
...
s32 gup_load_calibration(const u8 *firmware, s32 length, u8 need_check);
