 ...
 */
#define FTS_CHIP_TYPE   _FT6336U //_FT8716
...
//#define FTS_TPD_PROXIMITY						1


/* 
 * FTS_MTK_LTE is chose structure hwmsen_object or control_path, data_path
 * FTS_MTK_LTE = 0, is control_path, data_path
 * FTS_MTK_LTE = 1, hwmsen_object
 */
#define FTS_MTK_LTE               				0
